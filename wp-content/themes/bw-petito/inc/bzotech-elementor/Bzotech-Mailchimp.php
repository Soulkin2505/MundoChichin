 ...
 * @since 1.0.0
 */
class Bzotech_Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mailchimp', 'bw-petito' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elbzotech-mailchimp-default'		=> esc_html__( 'Default', 'bw-petito' ),
		...
		$this->add_control(
			'desc', [
				'label' => __( 'Description', 'bw-petito' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter description', 'bw-petito' ),
				'label_block' => true,
				'condition' => [
					'style' =>  ['style2'],
				]
		...
		$this->add_control(
			'form_id',
			[
				'label' => esc_html__( 'Form ID', 'bw-petito' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Your email address', 'bw-petito' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elbzotech-mailchimp-wrap form' => 'line-height: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'bw-petito' ),
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .elbzotech-mailchimp-form',
			]
		);
		...
		$this->start_controls_section(
			'section_style_input',
			[
				'label' => esc_html__( 'Input', 'bw-petito' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'input_color',
			[
				'label' => esc_html__( 'Input Color', 'bw-petito' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'bw-petito' ),
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .elbzotech-mailchimp-form, {{WRAPPER}} input[type="email"]',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elbzotech-mailchimp-wrap .mc4wp-form-fields input[type="email"]' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		echo bzotech_get_template_widget('mailchimp/mailchimp',$settings['style'],$attr);
	}
