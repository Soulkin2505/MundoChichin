...
class Bzotech_Posts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts', 'bw-petito' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elbzotech-post-grid'		=> esc_html__( 'Default (Grid - list)', 'bw-petito' ),
					'elbzotech-post-slider'		=> esc_html__( 'Slider', 'bw-petito' ),
				],
			]
		);
		...
		$this->add_control(
			'type_active',
			[
				'label' 	=> esc_html__( 'Active type', 'bw-petito' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'grid',
				'options'   => [
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' => esc_html__( 'Grid', 'bw-petito' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_control(
			'item_style',
			[
				'label' 	=> esc_html__( 'Item style', 'bw-petito' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Style 1 - default', 'bw-petito' ),
					'style2'		=> esc_html__( 'Style2 - home 1', 'bw-petito' ),
					'style3'		=> esc_html__( 'Style3 - home 2', 'bw-petito' ),
					'style4'		=> esc_html__( 'Style4 - home 4', 'bw-petito' ),
					'style5'		=> esc_html__( 'Style5 - home 6', 'bw-petito' )
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'grid-custom'	=> esc_html__( 'Grid custom', 'bw-petito' ),
				],
				'condition' => [
					'display' => 'elbzotech-post-grid',
				]
		...
		$repeater_grid_custom->add_responsive_control(
			...
			[
				...
				'default' => esc_html__( 'Enter number column' , 'bw-petito' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$repeater_grid_custom->add_responsive_control(
			'row_grid', 
			[
				'label' => esc_html__( 'Row grid', 'bw-petito' ),
				'default' => esc_html__( 'Enter number row' , 'bw-petito' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => [
					'1'  => esc_html__( '1', 'bw-petito' ),
		...
		$this->add_control(
			'list_grid_custom',
			[
				'label' => esc_html__( 'Add column row', 'bw-petito' ),
		...
		$this->add_control(
			'item_meta',
			[
				'label' => esc_html__( 'Meta data', 'bw-petito' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'bw-petito' ),
				'label_off' => esc_html__( 'Off', 'bw-petito' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_meta_select',
			[
				'label' 	=> esc_html__( 'Meta', 'bw-petito' ),
		...
		$this->start_controls_section(
			'section_list',
			[
				'label' => esc_html__( 'List', 'bw-petito' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display' => 'elbzotech-post-grid',
				]
		...
		$this->add_responsive_control(
			'meta_space',
			[
				'label' => esc_html__( 'Space meta item', 'bw-petito' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_icon_size',
			[
				'label' => esc_html__( 'Icon size', 'bw-petito' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'meta_icon_space',
			[
				'label' => esc_html__( 'Space icon', 'bw-petito' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_bottom_space',
			[
				'label' => esc_html__( 'Space bottom', 'bw-petito' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
	...
	protected function render() {
        ...
        bzotech_get_template_widget('posts/'.$view,'',$attr,true);
        wp_reset_postdata();
	}
