    ...
    class Bzotech_Woocommerce_Attributes{
        ...
        static function bzotech_product_option_terms_attribute( $taxonomy, $index ) {
            $types = array(
                ...
                'image' => esc_html__( 'Image', 'bw-petito' ),
            ...
            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'bw-petito' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo esc_attr($index); ?>][]">
                <?php
            ...
            <button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'bw-petito' ); ?></button>
            <button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'bw-petito' ); ?></button>
            <button class="button fr plus tawcvs_add_new_attribute" data-type="<?php echo esc_attr($taxonomy->attribute_type); ?>"><?php esc_html_e( 'Add new', 'bw-petito' ); ?></button>
