...
if(!class_exists('Bzotech_Category_Fillter') && class_exists("woocommerce"))
{
    class Bzotech_Category_Fillter extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('BZOTECH Categories Filter','bw-petito'),
                    ...
                    echo        '<ul>';                
                        ...
                        foreach ($category as $cat_slug) {
                            ...
                            if(is_object($cat)){
                                ...
                                echo        '<li><a data-cat='.esc_attr($cat->slug).' href="'.esc_url(bzotech_get_filter_url('product_cat',$cat->slug)).'" class="load-shop-ajax '.$active.'"> '.$cat->name.'</a><span class="smoke">('.$cat->count.')</span></li>';
                            }
                        }
                    echo      '</ul>';
                }      
        ...
        function form( $instance ) {
            ...
            <p>
                <label><?php esc_html_e( 'Categories:' ,'bw-petito'); ?></label></br>
                <?php 
                ...
                else echo esc_html__("No any category.",'bw-petito');
                ?>
            </p>            
        <?php
        }
