...
if(!class_exists('Bzotech_BlogListPostsWidget'))
{
    class Bzotech_BlogListPostsWidget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('BZOTECH Posts List','bw-petito'),
                array( 'description' => esc_html__( 'Posts list', 'bw-petito' ), ));

            $this->default=array(
                'title'=>esc_html__('List Posts','bw-petito'),
                'posts_per_page'=>8,
                'style'=>'default',
                'category'=>'',
                'order'=>'desc',
        ...
        function widget( $args, $instance ) {
            ...
            echo bzotech_get_template_widget('widgets/post',false,array(
                'instance'=>$instance,
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title' ,'bw-petito'); ?></label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'posts_per_page' )); ?>"><?php esc_html_e( 'Post Number' ,'bw-petito'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'order_by' )); ?>"><?php esc_html_e( 'Order By' ,'bw-petito'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'order' )); ?>"><?php esc_html_e( 'Order' ,'bw-petito'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'category' )); ?>"><?php esc_html_e( 'Category' ,'bw-petito'); ?></label>

                <?php wp_dropdown_categories(array(
                    'selected'=>$category,
                    'show_option_all'=>esc_html__('--- Select ---','bw-petito'),
                    'name'  =>$this->get_field_name( 'category' )
                )); ?>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'number_row' )); ?>"><?php esc_html_e( 'Number product in item silder (Default: 4)' ,'bw-petito'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'image_size' )); ?>"><?php esc_html_e( 'Custom image size (Example: enter size in pixels : 200x100 (Width x Height))' ,'bw-petito'); ?></label>
