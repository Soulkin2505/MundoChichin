...
<div class="bzotech-col-md-12">
    <div class="item-post item-list-post-style4 flex-wrapper align_items-center">
        ...
        <?php endif;?>
            <div class="post-info">
                <div class="post-info2">
                    ...
                    <?php if($item_title == 'yes'):?><h3 class="title36 post-title font-bold font-title"><a class=" color-title" href="<?php echo esc_url(get_the_permalink()) ?>"><?php the_title()?> <?php echo (is_sticky()) ? '<i class="sticky-icon las la-star"></i>':''?></a></h3><?php endif?>
                    <?php if($item_meta == 'yes') bzotech_display_metabox('detail-post',$item_meta_select,'','meta-post-style1');?>
                    <?php if($item_excerpt == 'yes') echo '<p class="desc color-title title20">'.get_the_excerpt().'</p>';?>
