...
if($check_related == '1'):
    ...
    $title_df   = esc_html__("Related Posts",'bw-petito');
    ...
    <div class="single-related-post">
         <div class="title-line">
        	<h3 class="title24 font-title color-title font-bold ">
        ...
        $button_icon_pos = $button_icon = $item_button = '';
        $button_text = esc_html__("Read more", 'bw-petito');
        $item_thumbnail = $item_title = $item_excerpt =  $item_meta = 'yes';
    	...
    	<div class="related-post-slider">
            ...
            >
                ...
                <?php if ( $navigation == 'yes' ):?>
                    <div class="swiper-button-nav swiper-button-next"><i class="fas fa-chevron-right"></i></div>
                    <div class="swiper-button-nav swiper-button-prev"><i class="fas fa-chevron-left"></i></div>
                <?php endif?>
