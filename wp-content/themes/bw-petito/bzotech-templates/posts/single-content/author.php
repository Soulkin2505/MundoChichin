...
?>
    ...
    <?php 
    if($sidebar['position'] =='no') {
        ?>
        <div data-elementor-type="wp-post" data-elementor-id="492" class="elementor elementor-492" data-elementor-settings="[]">
        <div class="elementor-inner">
        <div class="elementor-section-wrap">
        <section class="section-author-full elementor-section elementor-top-section elementor-element  elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"  data-element_type="section" data-id="b6d0539" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
            <div class="col-section-author">
    <?php } ?>
        ...
        <div class="post-info-author-style1 flex-wrapper align-content-center">
        	...
        	<div class="author-info">
                ...
                <a class="link-author-post" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">All Author Post</a>
