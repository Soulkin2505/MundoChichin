...
if($sidebar_pos!=='no'){
    $thumb_class = 'bzotech-col-lg-6 bzotech-col-md-6 bzotech-col-sm-6';
    $info_class = 'bzotech-col-lg-6 bzotech-col-md-6 bzotech-col-sm-6';
...
?>
<div class="product-detail gallery-vertical-mobi <?php echo esc_attr($get_style_woo_single);?>">
        ...
        <div class="<?php echo esc_attr($thumb_class)?>">
            <div class="product-detail-gallery-js product-detail-gallery <?php if($tab_style == 'tab-product-accordion2') echo 'tab-accordion-gallery-sticky'; ?> ">
                <div class="wrap-detail-gallery images <?php echo esc_attr($zoom_style)?>">
                    <div class=" 222 mid woocommerce-product-gallery__image image-lightbox" data-gallery="<?php echo esc_attr($gallerys)?>">
    ...
    <?php
    bzotech_product_sticky_addcart();
    ?>
</div>