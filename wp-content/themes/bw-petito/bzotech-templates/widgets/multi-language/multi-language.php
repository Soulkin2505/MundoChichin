...
namespace Elementor;
extract($settings);
$html ='<div class ="elbzotech-lang-globla elbzotech-lang-globla-'.$style.'">';
switch ($style) {
    case 'poly-style':
       ...
       if(!empty($data_demo)){
            ...
            foreach($data_demo as $key => $value){
                 if($key == 0){
                    ...
                    if($flag == 'yes') $lang_active .= wp_get_attachment_image($value['image']['id'],array(30,30));
                ...
                if($flag == 'yes') $lang_sub .= wp_get_attachment_image($value['image']['id'],array(30,30));
        ...
        if(defined('ICL_SITEPRESS_VERSION') && defined('ICL_LANGUAGE_CODE') ){
            ...
            foreach ($wpml_lang as $lang) {
                ...
                if($lang['active']){
                    ...
                    if($flag == 'yes') $lang_active .=  '<img alt="'.esc_attr__("flag",'bw-petito').'" src="'.esc_url($flag_url).'">';
                ...
                if($flag == 'yes') $lang_sub .=     '<img alt="'.esc_attr__("flag",'bw-petito').'" src="'.esc_url($flag_url).'">';
