...
echo bzotech_get_template('top-filter','',array('style'=>$type_active,'number'=>$number,'count_query'=>$post_query->found_posts,'show_number'=>$show_number,'show_type'=>$show_type));
$dem=1;
$dem_grid=0;
?>
