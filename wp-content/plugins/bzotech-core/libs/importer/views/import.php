...
<div class="wrap">
    ...
    <div id="message" class="updated">
        <p>
        The Demo content is a replication of the Live Content. By importing it, you could get several sliders, product,
        pages, posts, theme options, widgets, sidebars and other settings.<br>
        To be able to get them, make sure that you have installed and activated these plugins: Bzotech Core, Bzotech Elementor, WooCommerce, Redux Framework and Elementor, Contact form 7, Mailchimp for WordPress <br> <span style="color:#f0ad4e">
    ...
    <div class="list-demo-import" style="display:flex; flex-wrap: wrap;">
        <?php for($demo=1; $demo <= $bzotech_number_demo; $demo++) {?>
            <div class="list-demo-import__col" >
                <div class="list-demo-import__item" >
                    <?php
                    if($demo == '1')
                        $link_preview = 'https://bw-petito.bzotech.com/';
                    else
                        $link_preview = 'https://bw-petito-demo'.$demo.'.bzotech.com/'; ?>
